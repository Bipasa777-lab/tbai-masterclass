...
import { AvatarCircles } from './magicui/avatar-circles'; // Correct path
import { dummyAvatars, modules } from '@/constant'; // Correct import path
...
const ChooseUs = () => {
  ...
  return (
    <section className="w-full">
      {/* Features Section */}
      <section className="py-16 px-4 bgF5F5F5">
      ...
      <section className="py-16 px-4 bg-black">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-8 lg:gap-10 items-stretch">
          {/* Left: Modules */}
          ...
          <div className="w-full lg:w-[380px] bg-white rounded-2xl shadow-lg p-5 sm:p-6 flex flex-col justify-between">
            <div>
              ...
              <div className="flex items-center space-x-2 mb-4">
                <AvatarCircles numPeople={4800} avatarUrls={dummyAvatars.slice(0, 5)} />
              </div>
